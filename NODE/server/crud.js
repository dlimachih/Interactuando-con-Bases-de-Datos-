...
module.exports.crearUsuarioDemo = function(callback){ //Función para crear usuarios
  var arr = [{ email: 'demo@mail.com', user: "demo", password: "123456"}, { email: 'david@hotmail.com', user: "david", password: "123456"}]; //array con la información de los usuarios a insertar
